...
target_zip_release_channel=dyndetachx_${latest_tag_name}_release.zip
target_zip_beta_channel=dyndetachx_${latest_tag_name}_beta-channel.zip
...
# module.prop
[ $latest_tag_beta = false ] && {
updateJsonUrl="https:\/\/raw.githubusercontent.com\/nivranaitsirhc\/dyndetachx\/main\/configs\/update.json"
updateJsonChangelog="https:\/\/raw.githubusercontent.com\/nivranaitsirhc\/dyndetachx\/main\/changelog.md"
